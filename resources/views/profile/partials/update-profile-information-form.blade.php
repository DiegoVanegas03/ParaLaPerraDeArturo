<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="apellidoP" name="apellidoP" type="text" class="mt-1 block w-full" :value="old('apellidoP', $user->apellidoP)" required autofocus autocomplete="name" />
            <x-input-error class="mt-2" :messages="$errors->get('apellidoP')" />
        </div>

        <div>
            <x-input-label for="apellidoM" :value="__('Apellido materno')" />
            <x-text-input id="apellidoM" name="apellidoM" type="text" class="mt-1 block w-full" :value="old('apellidoM', $user->apellidoM)" required autofocus autocomplete="name" />
